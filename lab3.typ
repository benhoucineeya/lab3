...
#show: ieee.with(
  ...
  */
  ...
  ( 
    (
      name: "Ben Houcine Eya",
      department: [Dept. of EE],
      organization: [ISET Bizerte --- Tunisia],
      profile: "benhoucineeya",
      email: "ayoutabenhoucine1@gmail.com",
    ),
     )
  // index-terms: (""),
...
julia> cd("C:/Users/eya/OneDrive/Bureau/infodev-main/Codes/web-app")
julia> Genie.loadapp()
julia> up() 
```
...
`cd("C:\\Users\\eya\\OneDrive\\Bureau\\infodev-main\\Codes\\web-app")`This choose the current working directory in Julia to the specified path where your web application is located.
...
#figure(
	image("updated-sinewave.png", width: 100%),
